...
namespace AppBiblio.Controllers
{
    public class LibroesController : Controller
    {
        ...
        public LibroesController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,isbn,titulo,autor,editorial,genero,idioma")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,isbn,titulo,autor,editorial,genero,idioma")] Libro libro)
        {
            if (id != libro.id)
            {
                return NotFound();
